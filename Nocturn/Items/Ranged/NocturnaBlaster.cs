...
namespace Nocturn.Items.Ranged
{
	public class NocturnBlaster : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("With the power of all four Essence Biomes embude it with power");
		}
		...
		/*public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			float numberProjectiles = 3 + Main.rand.Next(10); // 3, 4, or 5 shots
